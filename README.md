...
- fixed body generated by the service: `tableHeaderList` object array, `startTime`, `endTime`, `currentTime`, complete `eventV2`, HAR-style `conditionList` condition groups, and `pagination`
