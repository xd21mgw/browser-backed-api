...
- fixed body generated by the service: `tableHeaderList` object array, `startTime`, `endTime`, `currentTime`, `eventV2.sourceIds` string, `conditionList` condition groups, and `pagination`
